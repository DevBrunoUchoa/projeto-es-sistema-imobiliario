...
export default function Perfil() {
  ...
  const {
    ...
    resetPicker: limparSeletorFoto,
  } = useFilePicker();

  const {
    inputRef: docInputRef,
    openPicker: abrirSeletorDoc,
    resetPicker: limparSeletorDoc,
  } = useFilePicker();
  ...
  useEffect(() => {
    ...
    userApi
      .buscar(user.id, { signal: controller.signal })
      .then((data) => {
        const normalized = {
          ...emptyProfile,
          ...data,
  ...
  async function promoverParaMista() {
    ...
    try {
      ...
      setMessage({
        type: 'success',
        text: 'Conta liberada como Misto — agora você também pode anunciar imóveis.',
      });
    } catch (err) {
      setMessage({
        type: 'error',
  ...
  async function onDocumentoSelecionado(event) {
    ...
    try {
      ...
      setMessage({
        type: 'success',
        text: 'Documento enviado! Vamos avisar quando a análise sair.',
      });
    } catch (err) {
      if (err.status === 409) {
        setVerificacaoStatus('pendente');
    ...
    <div className="app-shell">
      ...
      <main className="page-content profile-page">
        <div className="page-header">
          <div>
            <h1>Meu perfil</h1>
            <p>Gerencie os dados vinculados à sua conta.</p>
          </div>
        </div>
        ...
        <div className="profile-avatar-section">
          <div className="avatar-wrap">
            ...
            >
              <i
                className={`fa-solid ${
                  enviandoFoto ? 'fa-spinner fa-spin' : 'fa-camera'
                }`}
              />
            </button>
          ...
          <div className="avatar-info">
            ...
            <p>
              ...
              {profile.instituicao || 'Instituição não informada'}
            </p>
        ...
        <div className="card-section">
          <div className="card-section-title">
            ...
            <div className="title-actions">
              ...
              >
                <i
                  className={`fa-solid ${editing ? 'fa-xmark' : 'fa-pen'}`}
                />{' '}
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <small className="field-help">
                O backend não oferece alteração de e-mail nesta rota.
              </small>
            </div>
        ...
        {profile.tipoConta === 'ESTUDANTE' && (
          <div className="card-section">
            ...
            >
              Também quer alugar um quarto na sua república? Vire uma conta
              Misto e ganhe acesso pra anunciar imóveis sem perder seu perfil de
              estudante.
            </p>
            ...
            <button
              className="btn-sm btn-primary"
              disabled={promovendo}
              onClick={promoverParaMista}
            >
              {promovendo
                ? 'Ativando...'
                : 'Oferecer vaga na minha república'}
            </button>
          </div>
        )}

        {profile.tipoConta === 'MISTO' && (
          <div className="card-section">
            <div className="card-section-title">
              Conta Misto ativa
            </div>
            ...
            >
              Você já pode <Link to="/criar-anuncio">anunciar imóveis</Link>{' '}
              além do seu perfil de estudante.
            </p>
          </div>
        )}

        {(profile.tipoConta === 'LOCADOR' ||
          profile.tipoConta === 'MISTO') &&
          !profile.verificado && (
            <div className="card-section">
              <div className="card-section-title">
              ...
              {verificacaoStatus === 'pendente' ? (
                ...
                >
                  <i
                    ...
                    style={{ marginRight: 6 }}
                  />{' '}
                  Documento em análise. Avisamos quando sair o resultado.
                </p>
              ) : (
                <>
                  <p
                  ...
                  >
                    Envie um documento (RG, CNH ou CRECI) pra ganhar o selo de
                    verificado e passar mais confiança aos estudantes.
                  </p>
        ...
        >
          ...
          {!confirmandoExclusao ? (
            <>
              ...
              >
                Remove permanentemente seus dados da plataforma, conforme a
                LGPD. Essa ação não pode ser desfeita.
              </p>
            ...
            <>
              ...
              >
                Tem certeza? Seus dados serão apagados e você sairá da conta
                imediatamente.
              </p>
