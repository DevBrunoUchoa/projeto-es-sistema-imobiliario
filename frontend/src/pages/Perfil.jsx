...
export default function Perfil() {
  ...
  return <div className="app-shell"><header className="topbar"><div className="brand"><div className="logo-mark">C</div><span className="logo-text">Campus<strong>Living</strong></span></div><button className="btn-sm btn-outline" onClick={logoutLocal}><i className="fa-solid fa-arrow-right-from-bracket"/> Sair da interface</button></header><main className="page-content profile-page">
